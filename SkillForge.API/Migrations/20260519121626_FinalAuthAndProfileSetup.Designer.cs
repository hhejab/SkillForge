...
namespace SkillForge.API.Migrations
{
    ...
    [Migration("20260519121626_FinalAuthAndProfileSetup")]
    partial class FinalAuthAndProfileSetup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillForge.API.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SkillForge.API.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SkillForge.API.Models.Instructor", b =>
                {
                    b.HasOne("SkillForge.API.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("SkillForge.API.Models.Instructor", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SkillForge.API.Models.Trainee", b =>
                {
                    b.HasOne("SkillForge.API.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("SkillForge.API.Models.Trainee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
